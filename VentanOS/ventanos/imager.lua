...
---@param x_dest integer Optional. X coordinate of the pixel of the screen that will display the top-left most pixel of the image
---@param y_dest integer Optional. Y coordinate of the pixel of the screen that will display the top-left most pixel of the image
---@param x_source integer Optional. X coordinate of the top-left most pixel of the screen to be displayed
---@param y_source integer Optional. Y coordinate of the top-left most pixel of the screen to be displayed
---@param max_width integer Optional. Maximun width of the image to be displayed(the image will be cropped)
---@param max_height integer Optional. Maximun heigth of the image to be displayed(the image will be cropped)
